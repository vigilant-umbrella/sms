...
def layout(g, settings):
    ...
    if os.name == "nt":
        main_menu = [
            ...
            [
                sg.Text("Operating System: ", font=("Montserrat", 10, "bold")),
                sg.Text(g.os()),
            ],
            [
                sg.Text("Uptime: ", font=("Montserrat", 10, "bold")),
                sg.Text("{} seconds".format(g.uptime()), key="-update-"),
            ],
            ...
            [
                sg.Text("Used: ", font=("Montserrat", 10, "bold")),
                sg.Text("{:,} Bytes".format(memory_dict["used_incl"])),
            ],
            [
        ...
        main_menu = [
            ...
            [sg.Text("\nCPU - ", font=("Montserrat", 10, "bold"))],
            [
                sg.Text("Load Average: ", font=("Montserrat", 10, "bold")),
                sg.Text(
                    "{}  {}  {}".format(
                        cpu_dict["load_avg"][0],
                        cpu_dict["load_avg"][1],
    ...
    main_menu += [
        ...
        [
            sg.Text("Used: ", font=("Montserrat", 10, "bold")),
            sg.Text("{:,} Bytes ({}%)".format(swap_dict["used"], swap_dict["percent"])),
        ],
        [
            sg.Text("Free: ", font=("Montserrat", 10, "bold")),
    ...
    main_menu = [
        [
            sg.Column(
                main_menu, scrollable=True, vertical_scroll_only=True, size=(1000, 650)
            )
        ]
    ] + [
        [
    ...
    cpu_menu = [
        [
            sg.Column(
                cpu_menu, scrollable=True, vertical_scroll_only=True, size=(1000, 650)
            )
        ]
    ] + [
        [
    ...
    memory_menu += [
        ...
        [
            sg.Text("Used (excl. Cache & buffer): ", font=("Montserrat", 10, "bold")),
            sg.Text(
                "{:,} Bytes ({}%)".format(
        ...
        [
            sg.Text("Used (incl. Cache & buffer): ", font=("Montserrat", 10, "bold")),
            sg.Text("{:,} Bytes".format(memory_dict["used_incl"])),
        ],
        [
            sg.Text("Free: ", font=("Montserrat", 10, "bold")),
    ...
    for i in range(10):
        try:
            ...
            process_menu += [
                ...
                [
                    sg.Text("Created: ", font=("Montserrat", 10, "bold")),
                    sg.Text(
    ...
    for network_dict in networks:
        if os.name == "nt":
            network_menu += [
                ...
                [
                    sg.Text("Packets received: ", font=("Montserrat", 10, "bold")),
                    sg.Text("{}".format(network_dict["packets_recv"])),
                ],
                [
    ...
    misc_menu = [
        [
            sg.Column(
                misc_menu, scrollable=True, vertical_scroll_only=True, size=(1000, 650)
            )
        ]
    ] + [
        [
    ...
    settings = [
        [
            sg.Text("Current name(s) - email(s): "),
            sg.Listbox(n_e, key="-email-", size=(100, 10), enable_events=True),
        ],
        [
            ...
            sg.TabGroup(
                [
                    [
                        ...
                        sg.Tab(
                            "Memory Menu", memory_menu, element_justification="center"
                        ),
                        sg.Tab(
                            "Process Menu", process_menu, element_justification="center"
                        ),
                        sg.Tab(
                            "Storage Menu", storage_menu, element_justification="center"
                        ),
                        sg.Tab(
                            "Network Menu", network_menu, element_justification="center"
                        ),
                        sg.Tab("Misc Menu", misc_menu, element_justification="center"),
                        sg.Tab(
                            "Settings Menu", settings, element_justification="center"
                        ),
                    ]
                ],
                border_width=5,
    ...
    window = sg.Window(
        "System Monitoring System", layout, size=(1000, 800), element_justification="c"
    )
    return window
        ...
        if event in ("Exit", sg.WIN_CLOSED):
            ...
            if values[0] == "" or values[1] == "":
                ...
                try:
                    ...
                    sg.popup(
                        "Malformed JSON settings file. Delete it and start afresh!",
                        title="Error",
                    )
